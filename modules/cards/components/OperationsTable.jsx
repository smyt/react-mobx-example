...
import {
  Button, Table, Divider, Menu, Dropdown, Icon, Popconfirm, Tooltip,
} from 'antd'
  ...
  getToolbar() {
    ...
    return (
      <div style={{ marginBottom: 5 }}>
        ...
        <Popconfirm
          title="Вы уверены, что хотите удалить все транзакции за текущий период?"
  ...
  getOperationEditWindow() {
    ...
    return (
      ...
      >
        ...
        && <OperationForm record={me.state.record} />
        }
      </BaseModalWindow>
    )
  }
  ...
  getAddPatternWindow() {
    ...
    return (
      ...
      >
        ...
        && <PatternCopyForm categories={categories.data.toJS()} selection={me.state.selection} />
        }
      </BaseModalWindow>
    )
  }
  ...
  getSetCategoryWindow() {
    ...
    return (
      ...
      >
        ...
        && <CategoriesChoiceForm categories={categories.data.toJS()} />
        }
      </BaseModalWindow>
    )
  }
